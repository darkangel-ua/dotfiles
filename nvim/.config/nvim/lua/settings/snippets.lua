...
ls.add_snippets("cpp", {
    ...
    ls.parser.parse_snippet({trig = "ele"}, "EXPECT_LE(${1:expected}, ${2:actual});$0"),
    ls.parser.parse_snippet({trig = "elt"}, "EXPECT_LT(${1:expected}, ${2:actual});$0"),
    ...
    ls.parser.parse_snippet({trig = "ale"}, "ASSERT_LE(${1:expected}, ${2:actual});$0"),
    ls.parser.parse_snippet({trig = "alt"}, "ASSERT_LT(${1:expected}, ${2:actual});$0"),
